...
import (
	...
	kubernetesv1alpha1 "github.com/juan-lee/ctrlarm/pkg/apis/kubernetes/v1alpha1"
	"github.com/juan-lee/ctrlarm/pkg/reconciler/cluster"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &kubernetesv1alpha1.Cluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &kubernetesv1alpha1.Cluster{}
	...
	cr, err := cluster.NewReconciler()
	if err != nil {
		return reconcile.Result{}, err
	}

	_, err = cr.Reconcile(context.TODO(), instance)
	if err != nil {
		return reconcile.Result{}, err
	}
